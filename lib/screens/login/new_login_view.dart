...
class NewLoginView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => LoginCubit(),
      child: const _NewLoginViewBody(),
    );
  }
}

class _NewLoginViewBody extends StatefulWidget {
  const _NewLoginViewBody();

  @override
  State<_NewLoginViewBody> createState() => _NewLoginViewBodyState();
}

class _NewLoginViewBodyState extends State<_NewLoginViewBody> {
