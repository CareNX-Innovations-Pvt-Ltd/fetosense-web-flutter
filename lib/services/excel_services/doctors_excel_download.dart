...
/// A service for exporting doctor data to an Excel file.
///
/// The `ExcelExportService` class provides a method to export doctor data
...
class ExcelExportService {
  ...
  /// given doctor data, and then triggers a download of the generated Excel file.
  ///
